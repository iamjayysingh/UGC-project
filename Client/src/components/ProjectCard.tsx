                ...
                >
                  ...
                  {(gen.generatedImage || gen.generatedVideo) && (
                    <button
                      ...
                      className="flex gap-2 items-center px-4 py-2 hover:bg-black/10 cursor-pointer w-full"
                    >
                  ...
                  <button
                    ...
                    className="flex gap-2 items-center px-4 py-2 hover:bg-red-950/10 cursor-pointer w-full text-red-400"
                  >
